...
def main():
    ...
    # The last layer in alexnet is a linear one with softmax classification for 1000 classes.
    # We are replacing it with a linear layer with 3 classes.
    # After this only our output layer will have requires_grad == True.
    ...
    ## Manager setup
    manager = ModelManager(model, loss_fn, optimizer, tag="alexnet_classification")
